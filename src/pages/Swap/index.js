...
export default function TokenSwap() {
  ...
  const getTokenBalance = async (tokenSymbol) => {
    ...
    const tokenBalance = await axios.post("/account/balances", {
      ...
      <Row type="flex" justify="center">
        <Col xs={24} lg={10}>
          <div className="swap-card block">
            ...
            {tab === "liquidity" && (
              <div>
                <div className="prices-pool-share-title">Prices and pool share</div>
            ...
            <div className="handle-area">
              {Object.keys(actionInfo).length > 0 &&
                !actionInfo.allowance_satisfied && (
                  <Button className="btn-black" onClick={doApprove}>
